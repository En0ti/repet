...
![Задача тип 1: тождественно истинная формула с числами](/task15-type1.png)
...
![Задача тип 2: отрезки на числовой прямой](/task15-type2.png)
...
![Задача тип 3 (минимум): множества](/task15-type3min.png)
...
![Задача тип 3 (максимум): множества](/task15-type3max.png)
