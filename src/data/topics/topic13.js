...
\`\`\`svg
<svg viewBox="0 0 580 148" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto">
  <defs><style>
    .hdr{fill:#065f46}.r0{fill:#1e3a5f}.r1{fill:#1e293b}.rB{fill:#3b1e1e}
    .ht{fill:#fff;font:bold 12px sans-serif;text-anchor:middle;dominant-baseline:middle}
    .lbl{font:bold 12px sans-serif;dominant-baseline:middle}
    .desc{fill:#cbd5e1;font:11px sans-serif;dominant-baseline:middle}
    .ex{fill:#94a3b8;font:10px monospace;text-anchor:middle;dominant-baseline:middle}
    .sep{stroke:#334155;stroke-width:0.5}
  </style></defs>

  <rect width="580" height="32" class="hdr"/>
  <text x="95"  y="16" class="ht">Тип</text>
  <text x="340" y="16" class="ht">Описание</text>
  <text x="530" y="16" class="ht">Пример</text>

  <rect y="32" width="580" height="38" class="r0"/>
  <text x="8"   y="51" class="lbl" fill="#60a5fa">Адрес сети</text>
  <text x="200" y="51" class="desc">Переменная часть = все нули. Вычисляется как Маска AND IP.</text>
  <text x="530" y="51" class="ex">192.168.0.0</text>

  <rect y="70" width="580" height="38" class="r1"/>
  <text x="8"   y="89" class="lbl" fill="#34d399">Адреса узлов</text>
  <text x="200" y="89" class="desc">Переменная часть от 0001 до 1110. Это реальные устройства в сети.</text>
  <text x="530" y="89" class="ex">.1 — .14</text>

  <rect y="108" width="580" height="38" class="rB"/>
  <text x="8"   y="127" class="lbl" fill="#f87171">Broadcast</text>
  <text x="200" y="127" class="desc">Переменная часть = все единицы. Пакет доставляется всем в сети.</text>
  <text x="530" y="127" class="ex">192.168.0.15</text>

  <line x1="190" y1="32" x2="190" y2="146" class="sep"/>
  <line x1="490" y1="32" x2="490" y2="146" class="sep"/>
  <rect width="580" height="148" fill="none" stroke="#1e293b" stroke-width="1.5" rx="6"/>
</svg>
\`\`\`
